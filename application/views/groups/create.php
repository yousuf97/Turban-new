                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>Order Tables</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createReservation"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateReservation"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewReservation"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteReservation"></td>
                      </tr>
                      <tr>
                        <td>Category</td>
					  ...
					  <tr>
                        <td>Gallery</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createGallery"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateGallery"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewGallery"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteGallery"></td>
                      </tr>
                      <tr>
                        <td>Product</td>
					  ...
					  <tr>
                        ...
                        <td><input type="checkbox" name="permission[]" id="permission" value="createTakeAwayOrder"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateTakeAwayOrder"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewTakeAwayOrder"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteTakeAwayOrder"></td>
                      </tr>
                      <tr>
                        <td>Report</td>
                        <td> - </td>
