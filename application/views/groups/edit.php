...
<?php #echo $this->db->last_query();# print_r($group_data);?>
                ...
                <div class="form-group">
                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Banners</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createBanner" <?php 
                        if($serialize_permission) {
                          if(in_array('createBanner', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateBanner" <?php 
                        if($serialize_permission) {
                          if(in_array('updateBanner', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewBanner" <?php 
                        if($serialize_permission) {
                          if(in_array('viewBanner', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteBanner" <?php 
                        if($serialize_permission) {
                      ...
                      <tr>
                        <td>Order Tables</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createReservation" <?php 
                        if($serialize_permission) {
                          if(in_array('createReservation', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateReservation" <?php 
                        if($serialize_permission) {
                          if(in_array('updateReservation', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewReservation" <?php 
                        if($serialize_permission) {
                          if(in_array('viewReservation', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteReservation" <?php 
                        if($serialize_permission) {
                          if(in_array('deleteReservation', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td>Gallery</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createGallery" <?php 
                        if($serialize_permission) {
                          if(in_array('createGallery', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateGallery" <?php 
                        if($serialize_permission) {
                          if(in_array('updateGallery', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewGallery" <?php 
                        if($serialize_permission) {
                          if(in_array('viewGallery', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteGallery" <?php 
                        if($serialize_permission) {
                          if(in_array('deleteGallery', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                      </tr>
                      <tr>
                       ...
                       <tr>
                        ...
                        <td><input type="checkbox" name="permission[]" id="permission" value="createTakeAwayOrder" <?php 
                        if($serialize_permission) {
                          if(in_array('createTakeAwayOrder', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateTakeAwayOrder" <?php 
                        if($serialize_permission) {
                          if(in_array('updateTakeAwayOrder', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewTakeAwayOrder" <?php 
                        if($serialize_permission) {
                          if(in_array('viewTakeAwayOrder', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteTakeAwayOrder" <?php 
                        if($serialize_permission) {
                          if(in_array('deleteTakeAwayOrder', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                      </tr>
                      <tr>
