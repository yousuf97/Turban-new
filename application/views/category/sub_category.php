...
<div class="modal fade" tabindex="-1" role="dialog" id="addModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('category/sub_create') ?>" method="post" id="createForm">
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('category/sub_update') ?>" method="post" id="updateForm">

        <div class="modal-body">
          <div id="messages"></div>

          <div class="form-group">
            <label for="category_id_edit">Parent Category</label>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('category/sub_remove') ?>" method="post" id="removeForm">
        <div class="modal-body">
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'category/sub_fetchCategoryData',
    'order': []
  });
...
{ 
  $.ajax({
    url: base_url + 'category/fetchsubCategoryDataById/'+id,
    type: 'post',
    dataType: 'json',
    success:function(response) {
