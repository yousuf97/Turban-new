          ...
          <form role="form" action="" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Enter product name" autocomplete="off" value="<?php echo ($this->input->post('product_name'))?$edt:$product_data['name'] ?>" />
                </div>

                <div class="form-group">
                  <label for="product_name">Arabic product name</label>
                  <input type="text" class="form-control" id="arabic_product_name" name="arabic_product_name" placeholder="Enter arabic product name" autocomplete="off" value="<?php echo ($this->input->post('arabic_product_name'))?$edt:$product_data['arabic_name'] ?>" />
                </div>

                <div class="form-group">
                  <label for="price">Price</label>
                  <input type="text" class="form-control" id="price" name="price" placeholder="Enter price" autocomplete="off" value="<?php echo ($this->input->post('price')) ?$edt:$product_data['price'] ?>"/>
                </div>
                
                <div class="form-group">
                  <label for="addon">Addons</label>
                  <?php
                      foreach($addon_product as $ky=>$val)
                      {
                        echo "<span>".$val['addon']."</span> | ";
                      }
                      ?>
                  <select multiple class="form-control select_group" name="addons[]" id="">
                ...
                <div class="form-group">
                  ...
                  <?php
                      foreach($addon_product as $ky=>$val)
                      {
                        echo "<span>Qr. ".$val['price']."</span> | ";
                      }
                      ?>
                  <select multiple class="form-control select_group" name="addon_price[]" id="">
                ...
                <div class="form-group">
                  ...
                  <?php echo ($this->input->post('description')) ?$edt:$product_data['description'] ?>
                  </textarea>
                </div>
