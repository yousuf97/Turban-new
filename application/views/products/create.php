          ...
          <form role="form" action="" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="arabic_product_name" name="arabic_product_name" placeholder="Enter arabic product name" autocomplete="off" value="<?php echo $this->input->post('arabic_product_name') ?>" />
                </div>
