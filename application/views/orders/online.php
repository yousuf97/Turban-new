      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Manage Online Orders</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('orders/edit') ?>" method="post" id="editForm">

        <div class="modal-body">


          <div class="form-group">
            <label for="active">Paid-Unpaid Status</label>
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'orders/fetchOnlineOrdersData',
    'order': []
  });
