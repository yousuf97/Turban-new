...
<footer>
			...
			<div class="footer-top-area pt-100 pb-70 gray2-bg" style=" padding-bottom: 20px;padding-top: 70px;">
				<div class="container">
					<div class="row">
						...
						<div class="col-xl-3 col-lg-3 col-md-6">
							<div class="footer-wrapper mb-30">
								...
								<ul class="footer-menu">
									...
									<li><a href="menu"><i class="fas fa-caret-right"></i>Menu</a></li>
								</ul>
							</div>
						</div>
						<div class="col-xl-3 col-lg-3 col-md-6" style="padding-left: 0px;padding-right: 0px;">
							<div class="footer-wrapper mb-30">
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="copyright text-center">
							<p><a target="_blank" href="https://www.tfsbs.com">TFS-BS</a></p>
						</div>
					</div>
				</div>
			</div>
