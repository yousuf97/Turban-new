<?php
$edt='';
$menus=$this->model_special->get_menu_name($specials['menu_id']);
?>
      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Add Todays Special</h3>
          </div>
          <!-- /.box-header -->
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control" id="cate" onchange="get_menus(this.value)" name="category">
                        ...
                        {
                            if($specials['category_id']==$cat['id'])
                            {
                               ?>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control" id="menu" name="menu">
                        <option><?php echo $menus['name'];?></option>
                      </select>
                    </div>
                    <div class="form-group">
